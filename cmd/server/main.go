...
func main() {
	...
	{
		protected.POST("/sensors", api.AddSensorForUserHandler(db))
		protected.GET("/sensors", api.GetUserSensorsHandler(db))
		protected.DELETE("/sensors/:id", api.RemoveSensorForUserHandler(db))
	}
